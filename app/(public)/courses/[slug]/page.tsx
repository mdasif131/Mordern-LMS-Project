                      ...
                      <div className="border-t bg-muted/20">
                        <div className="space-y-3 p-6 pt-4">
                          {chapter.lessons.map((lesson, lessonIndex) => (
                            ...
                            >
                              <div className="flex size-8 items-center justify-center rounded-full border-2 border-primary/20 bg-background">
                                <IconPlayerPlay className="size-4 text-muted-foreground transition-colors group-hover:text-primary" />
                              </div>
